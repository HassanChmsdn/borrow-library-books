...
export const listAdminInventoryRecords = cache(
  async (): Promise<ReadonlyArray<AdminInventoryRecord>> => {
...
export const listAdminInventoryBookOptions = cache(
  async (): Promise<ReadonlyArray<AdminInventoryBookOption>> => {
