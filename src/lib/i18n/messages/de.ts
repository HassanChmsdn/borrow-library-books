export const deMessages = {
  ...
  literals: {
    ...
    public: {
      ...
      "Discover titles, compare availability, and start a borrowing request when a copy is ready.": "Entdecken Sie Titel, vergleichen Sie die Verfügbarkeit und starten Sie eine Ausleihanfrage, sobald ein Exemplar bereitsteht.",
      "Preparing catalog cards and filters.": "Katalogkarten und Filter werden vorbereitet.",
      "Preparing the collection.": "Der Bestand wird vorbereitet.",
      ...
      "Standard durations are fastest for staff confirmation.": "Standarddauern lassen sich vom Personal am schnellsten bestätigen.",
      "Leave blank to use the selected standard duration.": "Leer lassen, um die ausgewählte Standarddauer zu verwenden.",
      ...
      "Book not available": "Buch nicht verfügbar",
      ...
      "Try another title from the catalog or return to the full collection.": "Versuchen Sie einen anderen Titel aus dem Katalog oder kehren Sie zum vollständigen Bestand zurück.",
    ...
    admin: {
      ...
      ,"Review pending approvals, active loans, overdue follow-up, returned records, and rejected request history in a dense but readable circulation workspace.": "Prüfen Sie ausstehende Freigaben, aktive Ausleihen, die Nachverfolgung überfälliger Fälle, zurückgegebene Einträge und den Verlauf abgelehnter Anfragen in einem dichten, aber gut lesbaren Ausleih-Arbeitsbereich."
      ...
      ,"Manage borrowing request": "Ausleihanfrage verwalten"
      ,"Adjust the assigned copy and lifecycle status from one admin surface.": "Passen Sie das zugewiesene Exemplar und den Lifecycle-Status in einer einzigen Admin-Ansicht an."
      ,"No active borrowings": "Keine aktiven Ausleihen"
      ,"No rejected requests": "Keine abgelehnten Anfragen"
      ,"No borrowings match this search": "Keine Ausleihen entsprechen dieser Suche"
      ,"Rejected": "Abgelehnt"
      ,"Rejected on": "Abgelehnt am"
      ,"Rejected borrowing requests will appear here to preserve circulation history without affecting inventory counts.": "Abgelehnte Ausleihanfragen erscheinen hier, um den Ausleihverlauf zu bewahren, ohne die Inventarzahlen zu beeinflussen."
      ...
      ,"No copy assigned": "Kein Exemplar zugewiesen"
      ,"Move the request through review, checkout, overdue follow-up, return, or cancellation from this dialog.": "Verschieben Sie die Anfrage in diesem Dialog zwischen Prüfung, Ausgabe, Nachverfolgung überfälliger Fälle, Rückgabe oder Stornierung."
      ,"Assigned copy": "Zugewiesenes Exemplar"
      ,"Choose which physical copy should stay attached while this request remains open or checked out.": "Wählen Sie, welches physische Exemplar zugeordnet bleiben soll, solange diese Anfrage offen oder ausgeliehen ist."
      ,"Returned and cancelled requests release the assigned copy automatically.": "Zurückgegebene und stornierte Anfragen geben das zugewiesene Exemplar automatisch frei."
      ,"Rejection note": "Ablehnungsvermerk"
      ,"Capture a short admin-facing reason for cancelling this request.": "Erfassen Sie einen kurzen, adminseitigen Grund für die Stornierung dieser Anfrage."
      ,"This note is stored with the borrowing request so staff can understand why it was closed.": "Dieser Hinweis wird mit der Ausleihanfrage gespeichert, damit Mitarbeitende nachvollziehen können, warum sie geschlossen wurde."
      ,"Select an assigned copy before saving this borrowing update.": "Wählen Sie ein zugewiesenes Exemplar aus, bevor Sie diese Ausleihänderung speichern."
      ,"Add a short rejection note before cancelling this borrowing request.": "Fügen Sie vor der Stornierung dieser Ausleihanfrage einen kurzen Ablehnungsvermerk hinzu."
      ,"Cancelled": "Storniert"
      ,"Borrow request approved.": "Ausleihanfrage genehmigt."
      ,"Borrow request rejected.": "Ausleihanfrage abgelehnt."
      ,"Borrowing marked as returned.": "Ausleihe als zurückgegeben markiert."
      ,"Borrow request updated.": "Ausleihanfrage aktualisiert."
      ,"Only pending, active, or overdue borrow requests can be managed manually.": "Nur ausstehende, aktive oder überfällige Ausleihanfragen können manuell verwaltet werden."
      ,"This borrowing request cannot move to the selected status.": "Diese Ausleihanfrage kann nicht in den gewählten Status überführt werden."
      ...
      ,"Track current loans, pending requests, rejected history, and overdue items in the authenticated member account view.": "Verfolgen Sie aktuelle Ausleihen, ausstehende Anfragen, den Verlauf abgelehnter Anfragen und überfällige Titel in der authentifizierten Kontenansicht für Mitglieder."
      ,"Browse more books": "Weitere Bücher durchsuchen"
      ,"Dismiss": "Schließen"
      ...
      ,"Rejected requests kept for account history and follow-up context.": "Abgelehnte Anfragen bleiben hier für den Kontoverlauf und den Nachverfolgungskontext sichtbar."
      ,"Rejected borrowing requests will appear here so the account keeps a lightweight request history.": "Abgelehnte Ausleihanfragen erscheinen hier, damit das Konto einen kompakten Anfrageverlauf behält."
      ,"Loading the current account view.": "Die aktuelle Kontenansicht wird geladen."
      ,"All Books": "Alle Bücher"
